    ...
    return (
        <>
            ...
            <Navbar bg="primary" variant="dark">
                <Navbar.Brand >BookSmart</Navbar.Brand>
                <Nav className="mr-auto">
                    <ul className="nav">
                    <li className="nav-item"><RegisterContainer/></li>
                    <li className="nav-item"><LoginContainer /></li>
                    </ul>
                </Nav>
...
export default ({ handleInput, handleSubmit }) => {
  return (
    <Navbar bg="primary" variant="dark">
      <Navbar.Brand href="#home">BookSmart</Navbar.Brand>
      <Nav className="mr-auto">
